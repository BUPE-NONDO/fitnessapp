...
export default function UserProfile() {
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Fitness Level & Activity</h3>
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">Current Fitness Level</label>
  ...
  const renderStep4 = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-4">Select all that apply to your fitness journey</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {FITNESS_GOALS.map((goal) => (
            <label key={goal} className="flex items-center space-x-3 cursor-pointer p-3 border rounded-lg hover:bg-gray-50">
              <input
                type="checkbox"
